...
exports.execute = function (req, res) {
    console.log("EXECUTE HAS BEEN RUN req >>", req);
    ...
    JWT(req.body, process.env.jwtSecret, (err, decoded) => {
        ...
        if (decoded && decoded.inArguments && decoded.inArguments.length > 0) {
            ...
            if (decodedArgs.smsBoolean == 'False') {
                ...
                axios.post('https://devapi.globelabs.com.ph/smsmessaging/v1/outbound/9645/requests?access_token=EVcvVeC_ONoyUqRoigWMxkWKzjntsMQCsYtpFSUVyYc', { // Retrieving of token
...
function sendingToSFDC (statusOfMsg, campaignName, contactID, messageName) { //Function to connect to postgres Heroku Connect
    ...
    let queryCampaignID = `SELECT sfid, name FROM salesforceprod.Campaign WHERE Name = '${campaignName}'`;
    ...
    pool.query(queryCampaignID, (err, res) => {
        if (res.rows[0]) {
            ...
            let insertMobileSend = `INSERT INTO salesforceprod.et4ae5__SMSDefinition__c (et4ae5__Campaign__c, et4ae5__Contact__c, et4ae5__SendStatus__c, et4ae5__Campaigns__c, et4ae5__smsName__c) VALUES ('${campaignID}', '${contactID}', '${statusOfMsg}', '${campaignName}', '${messageName}') `;
...
exports.requestTemplate = function (req, res) {
    ...
    axios.post(tokenURL, { // Retrieving of token
        clientId: 'o8i9fgr8psdqizj0haoca7vm',
        clientSecret: 'SMv1ZkLIYA97QGoORuw83uKd'
    })
    .then(function (response) {
