define(['postmonger'], function (Postmonger) {
    ...
    let herokuURL = "https://ph-sms-app-tiger-prod.herokuapp.com/";
    ...
    function save() {
        //After clicking on save, it will pull the AJAX of contact builder
        ...
        var regexedStr = textMessageValue.replace(regexExp, function replace(match) {
            ...
            return '{{Event.' + eventDefinitionKey + '."' + eventSchema + words + '"}}'; 
        });
